  ...
  return (
    <section className="bg-goal bg-cover bg-center bg-no-repeat bg-fixed h-fit sm:h-[70vh] w-full">
      <div className="bg-black/60 w-hull h-fit sm:h-[70vh]">
        <div className="flex items-center justify-center py-8 sm:h-[70vh] text-white w-[90%] mx-[5%] 2xl:w-[1500px] 2xl:mx-auto">
          <p className="text-center text-lg font-slang sm:text-2xl font-semibold">
            {" "}
